...
export default function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-black/10 bg-[#0E2238] text-white">
      <div className="container-site grid gap-12 py-16 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs uppercase tracking-wider text-[#8EA4BA]">
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/70">
            {[
              ...
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="hover:text-[#8EA4BA] transition-colors"
                >
                  {link.name}
                </Link>
              </li>
      ...
      {/* Footer Bottom */}
      <div className="border-t border-white/10 bg-[#091829] py-6">
