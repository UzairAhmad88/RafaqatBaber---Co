    ...
    <section className="py-16 md:py-24">
      <div className="container-site">
        <motion.div
          ...
          className="relative rounded-[2.5rem] bg-[#123C32] px-8 py-16 text-white md:px-16 md:py-20 shadow-xl overflow-hidden"
        >
          {/* Subtle Abstract Lines */}
          <div className="absolute inset-0 pointer-events-none opacity-5">
            <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
              <path d="M-100 150 C 100 50, 200 250, 500 100 T 1100 300" fill="none" stroke="white" strokeWidth="2" />
              <path d="M-100 180 C 100 80, 200 280, 500 130 T 1100 330" fill="none" stroke="white" strokeWidth="2" />
            </svg>
          </div>

          <div className="relative z-10 max-w-4xl">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-[#A8BDAF]">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="group flex items-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-[#123C32] hover:bg-[#F7F6F1] transition-all duration-200 shadow-sm"
              >
