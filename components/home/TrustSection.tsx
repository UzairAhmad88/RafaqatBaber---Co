  ...
  return (
    <section className="bg-white py-24 md:py-32 overflow-hidden border-y border-black/5">
      <div className="container-site grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        >
          <span className="text-xs font-semibold tracking-[0.25em] uppercase text-[#1E3E62] mb-2">
            Who We Are
          </span>
          <div className="h-0.5 w-12 bg-[#C5A059] mt-2" />
        </motion.div>
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#0E2238] leading-tight mb-6">
