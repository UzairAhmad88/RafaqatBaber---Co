            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+92512856605" className="text-sm text-[#0E2238] font-semibold hover:text-[#1E3E62] transition-colors">
                    +92 51 2856605
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:islamabad@rafaqatbabar.com" className="text-sm text-[#0E2238] font-semibold hover:text-[#1E3E62] transition-colors">
