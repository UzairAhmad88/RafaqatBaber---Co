            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+92512856605" className="text-sm text-[#123C32] font-semibold hover:text-[#2F6F5E] transition-colors">
                    +92 51 2856605
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:islamabad@rafaqatbabar.com" className="text-sm text-[#123C32] font-semibold hover:text-[#2F6F5E] transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#68736E]">Saturday: By appointment only</p>
                </div>
              </div>
            </div>
          </motion.div>
