...
const steps = [
  {
    step: "01",
    name: "Onboarding",
    desc: "Set up your chart of accounts, understand your transaction volume, and integrate with your existing systems.",
  },
  {
    step: "02",
    name: "Recording",
    desc: "Systematically record all daily transactions, categorize expenses, and maintain clean general ledger entries.",
  },
  {
    step: "03",
    name: "Reconciliation",
    desc: "Perform monthly bank and inter-company reconciliations to ensure ledger accuracy and catch discrepancies early.",
  },
  {
    step: "04",
    name: "Reporting",
    desc: "Prepare management accounts, trial balances, and financial summaries in your required format and frequency.",
  },
  {
    step: "05",
    name: "Review",
    desc: "Conduct periodic reviews, financial health checks, and provide actionable commentary on cash positions.",
  },
];
