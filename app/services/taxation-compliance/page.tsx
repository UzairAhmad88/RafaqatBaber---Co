...
const steps = [
  { step: "01", name: "Assessment", desc: "Review your entity structure, income streams, and prior tax positions to identify optimization opportunities." },
  { step: "02", name: "Strategy", desc: "Design a compliant tax strategy aligned with ICAP guidelines, local tax law, and international treaty obligations." },
  { step: "03", name: "Preparation", desc: "Prepare accurate returns, schedules, and supporting documentation for corporate and personal filings." },
  { step: "04", name: "Filing", desc: "Submit verified returns to FBR and relevant authorities, ensuring deadlines and e-filing requirements are met." },
  { step: "05", name: "Representation", desc: "Handle queries, appeals, and notices from tax authorities on your behalf to resolve disputes efficiently." },
];
      ...
      <section className="container-site py-20 grid gap-12 lg:grid-cols-[1.3fr_0.7fr]">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border border-black/5 rounded-[2rem] p-8 shadow-sm text-center">
            <h3 className="text-lg font-bold text-[#123C32]">Optimize Tax Strategy</h3>
