...
const steps = [
  {
    step: "01",
    name: "Discovery",
    desc: "Conduct structured interviews, financial reviews, and operational walkthroughs to understand your business context.",
  },
  {
    step: "02",
    name: "Analysis",
    desc: "Build detailed financial models, scenario projections, and risk matrices based on real company data.",
  },
  {
    step: "03",
    name: "Insight",
    desc: "Translate quantitative findings into clear management-level insights and strategic option evaluations.",
  },
  {
    step: "04",
    name: "Recommendation",
    desc: "Present a concise, evidence-backed advisory report outlining recommended paths and their financial implications.",
  },
  {
    step: "05",
    name: "Implementation",
    desc: "Support execution of chosen strategies with ongoing monitoring, KPI tracking, and quarterly review sessions.",
  },
];
